			...
			while(num<1) // keep prompting for a positive integer.
                ...
                else
                {
                    ...
                    for(int i=3; i<=sqrt; i+=2) // 
                        ...
                        {
                            JOptionPane.showMessageDialog(null,"Number is not prime!", "Prime Number Analysis", JOptionPane.PLAIN_MESSAGE);
                            /*if number is divisible by any odd integer less than or equal to the square root of the number, then it is not PRIME!*/
